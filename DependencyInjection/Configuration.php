        ...
        $rootNode
            ->children()
                ...
                ->arrayNode('translation')
                    ->children()
                        ->scalarNode('spreadsheet')->defaultNull()->end()
                    ->end()
                ->end()
                ->arrayNode('google_drive')
                    ->addDefaultsIfNotSet()
                    ->children()
                        ->scalarNode('client_email')->defaultNull()->end()
                        ->scalarNode('client_real_email')->defaultNull()->end()
                        ->scalarNode('private_key')->defaultNull()->end()
                    ->end()
                ->end()
                ->arrayNode('routing')
                    ->children()
                        ->scalarNode('replace_symfony_router')->end()
                        ->variableNode('routers_by_id')->end()
                    ->end()
                ->end()
                ->arrayNode('languages')
                    ->children()
