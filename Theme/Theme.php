...
class Theme implements ArrayAccess
{
    ...
    {
        $header->setParameter('title', $container->getParameter('bigfoot.theme.values')['title']);
        $header->setParameter('subtitle', $container->getParameter('bigfoot.theme.values')['subtitle']);
